...
export function BrandHero() {
  return (
    <section className="hero-shell">
      <Image src="/game-cover.png" alt="Speed Keyboard Escape official Roblox cover art" width={768} height={432} priority sizes="100vw" className="hero-bg" />
      ...
      <div className="mx-auto flex min-h-[620px] max-w-7xl items-end px-4 py-10">
        <div className="relative w-full min-w-0 max-w-4xl pb-8">
          <p className="mb-4 slow down max-w-[21rem] whitespace-normal rounded-full border border-white/20 bg-black/45 px-3 py-1 text-xs font-semibold leading-5 text-[color:var(--accent)] sm:inline-flex sm:max-w-full sm:text-sm">
