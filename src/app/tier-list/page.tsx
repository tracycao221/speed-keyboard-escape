...
export const metadata: Metadata = {
  title: { absolute: `${siteConfig.gameName} Tier List: Best boosts by Role` },
  description: `Role-based ${siteConfig.gameName} tier list for beginner, racing, and farming boost choices, with live game confidence notes and no invented boost odds.`,
  alternates: { canonical: `${siteConfig.domain}/tier-list` },
  openGraph: {
    title: `${siteConfig.gameName} Tier List: Best boosts by Role`,
    description: `Role-based ${siteConfig.gameName} tier list for beginner, racing, and farming boost choices, with live game confidence notes and no invented boost odds.`,
...
export default function TierListPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        eyebrow="Tier list"
        title={`${siteConfig.gameName} Tier List for Starter, racing, and Farming Roles`}
        description="Use this tier list to compare role-based boost choices, what each pick is good for, and what still needs checking before you spend rare resources."
      />
      ...
      <section className="mt-10">
        <SectionHeader
          eyebrow="Rankings"
          title="Best current boost roles to compare first"
          copy="Compare beginner, farming, racing, and late-game roles with clear notes about when each pick is useful and what still needs source confirmation."
        />
