...
export const metadata: Metadata = {
  title: { absolute: `${siteConfig.gameName} Wiki: Codes, boosts & Tier List` },
  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <SectionHeader
            ...
            title={`${siteConfig.gameName} codes, boosts, and update status`}
            copy="Start with the verified code, then move into speed boost decisions, beginner guides, source checks, and role-based ranking notes."
          />
      ...
      <section className="bg-white/[0.025]">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 lg:grid-cols-[0.9fr_1.1fr]">
          <SectionHeader
            ...
            copy="The live game does not have a fully verified named boost meta yet, so this preview focuses on role-based choices players search for first."
          />
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <SectionHeader
          eyebrow="Core tools"
          title="Codes, boost help, and safe upgrade decisions"
          copy="Use the code page, how-to-get-boosts guide, tier list, calculator, and source checks before spending rare resources or committing to a build."
        />
      ...
      <section className="bg-black/25">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 lg:grid-cols-2">
          <div>
            <SectionHeader
              eyebrow="Guides"
              title="Pick the Speed Keyboard Escape guide that matches your search"
              copy="Use these guides when you need beginner steps, speed boost help, safer upgrade choices, farming routes, or advanced strategy."
            />
          ...
          <div>
            <SectionHeader
              ...
              title="Wiki topics for boosts, wins, map, and controls"
              copy="Use the wiki hub for Speed Keyboard Escape systems that affect your next code, boost, item, route, or speed control decision."
            />
            <div className="mt-6 grid gap-3">
              {wikiCards.map((item) => (
